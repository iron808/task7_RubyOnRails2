...
document.addEventListener("turbo:load", function () {
  ...
  if (toggle && dropmenu && !toggle.dataset.bound) {
...
document.addEventListener("turbo:load", function () {
  ...
  if (dotbutton && facilitymenu && !dotbutton.dataset.bound) {
    dotbutton.addEventListener('click', function () {
      facilitymenu.classList.toggle("active");
    });
    dotbutton.dataset.bound = "true";
  }
});
...
/******/ });
//# sourceMappingURL=application-ea52f665482f559f2c6b.js.map