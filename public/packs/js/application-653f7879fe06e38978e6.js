...
document.addEventListener("DOMContentLoaded", function () {
  // 最初の `.room` 要素を選択して dataset を使う
  var roomRate = parseFloat(document.querySelector('.room').dataset.roomRate);

  // `roomRate` を日本円形式でフォーマット
  ...
  // フォーマットされた価格を `.convert_rate` 要素に挿入
  document.querySelector('.convert_rate').textContent = formattedRoomRate;
});
...
/******/ });
//# sourceMappingURL=application-653f7879fe06e38978e6.js.map