...
document.addEventListener("DOMContentLoaded", function () {
  var roomRate = parseFloat(document.querySelectorAll(".room").dataset.roomRate);
  var formattedRoomRate = new Intl.NumberFormat('ja-JP', {
    style: 'currency',
    currency: 'JPY',
    minimumFractionDigits: 0
  }).format(roomRate);
  document.querySelectorAll(".convert_rate").textContent = formattedRoomRate;
});
...
/******/ });
//# sourceMappingURL=application-b22e03810477b836a978.js.map